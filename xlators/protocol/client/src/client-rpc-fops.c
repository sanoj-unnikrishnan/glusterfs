                        ...
                        struct iovec *iov, int count, void *myframe)
{
        ...
        ret = xdr_to_generic (*iov, &rsp, (xdrproc_t)xdr_gfs3_namelink_rsp);
        if (ret < 0) {
                rsp.op_ret   = -1;
                rsp.op_errno = EINVAL;
                goto out;
                       ...
                       struct iovec *iov, int count, void *myframe)
{
        ...
        ret = xdr_to_generic (*iov, &rsp, (xdrproc_t)xdr_gfs3_icreate_rsp);
        if (ret < 0) {
                rsp.op_ret   = -1;
                rsp.op_errno = EINVAL;
                goto out;
...
client3_3_namelink (call_frame_t *frame, xlator_t *this, void *data)
{
        ...
        ret = client_submit_request (this, &req, frame, conf->fops,
                                     ...
                                     NULL, NULL, 0, NULL, 0, NULL,
                                     (xdrproc_t)xdr_gfs3_namelink_req);
        if (ret) {
                gf_msg (this->name, GF_LOG_WARNING, 0, PC_MSG_FOP_SEND_FAILED,
                        "failed to send the fop");
        }
...
client3_3_icreate (call_frame_t *frame, xlator_t *this, void *data)
{
        ...
        ret = client_submit_request (this, &req, frame, conf->fops,
                                     ...
                                     NULL, NULL, 0, NULL, 0, NULL,
                                     (xdrproc_t) xdr_gfs3_icreate_req);
        if (ret)
                goto free_reqdata;
        GF_FREE (req.xdata.xdata_val);
        return 0;
